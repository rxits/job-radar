...
- CLI: `pnpm import-resume`, `pnpm scrape`, `pnpm match`, `pnpm digest` (daily briefing → `data/digests/<date>.md`; pure render in `src/lib/digest.ts`). Dashboard: `pnpm dev` → localhost:3000.
